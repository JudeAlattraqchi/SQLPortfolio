/* Maven Fuzzy Factory is online store saling four items, I used open sourse data to create multi sinarios 
...
/*
1st sinario:	Gsearch seems to be the biggest driver of our business. Could you pull monthly 
...
/*
2nd sinario.	Next, it would be great to see a similar monthly trend for Gsearch, but this time splitting out nonbrand 
...
/*
3rd sinario:	While we’re on Gsearch, could you dive into nonbrand, and pull monthly sessions and orders split by device type? 
...
/*
4th sinario:	I’m worried that one of our more pessimistic board members may be concerned about the large % of traffic from Gsearch. 
...
/*
5thsinario:	I’d like to tell the story of our website performance improvements over the course of the first 8 months. 
...
/*
6th sinario:	For the gsearch lander test, please estimate the revenue that test earned us 
...
/*
7th sinario:	For the landing page test you analyzed previously, it would be great to show a full conversion funnel 
